...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleAttribute = function (attributeName) {
  for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().get('https://jsonplaceholder.typicode.com/todos/1').then(res => console.log(res)); //dynamic dropdown
// $('.wrap').html(
//    `
//space for markup(html)
//    `
// );
